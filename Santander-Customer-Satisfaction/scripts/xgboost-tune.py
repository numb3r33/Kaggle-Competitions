...
train = pd.read_csv('./data/synthesized/train_vq.csv')
test = pd.read_csv('./data/synthesized/test_vq.csv')
...
param = dict([('max_depth', 3), ('learning_rate', 0.1), ('min_child_weight', 2),
