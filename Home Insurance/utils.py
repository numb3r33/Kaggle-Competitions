...
def prepare_sample(train):
	features = train.columns.drop('QuoteConversion_Flag')

	train_2013 = train[train.Original_Quote_Date.dt.year==2013].sample(n=1000)
	train_2014 = train[train.Original_Quote_Date.dt.year==2014].sample(n=1000)
	train_2015 = train[train.Original_Quote_Date.dt.year==2015].sample(n=1000)
